...
public class ClientSendAndReceiveUsageServerSocketAsyncTest
{
    //服务端采用原生socket发送接受
    ...
    public async ValueTask GlobalSetup()
    {
        ...
        await _serverIcop.ConnectAsync(new DnsEndPoint("127.0.0.1", 4040, System.Net.Sockets.AddressFamily.InterNetwork), CancellationToken.None);
    }
