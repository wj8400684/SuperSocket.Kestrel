...
public class ServerSendAndReceiveUsageClientSocketAsyncTest
{
    //服务端采用原生socket发送接受
    ...
    {
        _serverSocket = new IOCPTcpEasyClient<RpcPackageBase, RpcPackageBase>(new RpcPipeLineFilter(), new RpcPackageEncode());
